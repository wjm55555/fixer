...
const BLOCK_L_OVERHEAD: usize = std::mem::size_of::<char>() + std::mem::size_of::<usize>() + 2 * std::mem::size_of::<*mut u8>();
...
fn BLOCK_LIST_PREV(block: *mut u8) -> &'static mut *mut u8 {
    unsafe {
        &mut *((block as usize + std::mem::size_of::<char>() + std::mem::size_of::<usize>()) as *mut *mut u8)
    }
}

fn BLOCK_LIST_NEXT(block: *mut u8) -> &'static mut *mut u8 {
    unsafe {
        &mut *((block as usize + std::mem::size_of::<char>() + std::mem::size_of::<usize>() + std::mem::size_of::<*mut u8>()) as *mut *mut u8)
    }
}

fn BLOCK_DATA(block: *mut u8) -> *mut u8 {
    (block as usize + std::mem::size_of::<char>() + std::mem::size_of::<usize>() + 2 * std::mem::size_of::<*mut u8>()) as *mut u8
}
...
fn BLOCK_PTR_FROM_DATA(block: *mut u8) -> *mut u8 {
    (block as usize - 2 * std::mem::size_of::<*mut u8>() - std::mem::size_of::<usize>() - std::mem::size_of::<char>()) as *mut u8
}
...
fn BLOCK_ARR_PREV(block: *mut u8) -> *mut u8 {
    unsafe {
        ...
        (inner as usize - data_len - 2 * std::mem::size_of::<*mut u8>() - std::mem::size_of::<usize>() - std::mem::size_of::<char>()) as *mut u8
    }
}
...
fn allocator_list_search_by_sizemem(
    list: &mut ALLOCATOR_LIST,
    sizemem: usize,
) -> *mut u8 {
    unsafe {
...
pub fn allocator_free_block(a: allocator_type_t, ptrmem: *mut u8) {
    unsafe {
        ...
        if ((cur as usize + *BLOCK_L_DATA_LEN(cur) + BLOCK_OVERHEAD) >= ((*a).mem as usize + (*a).sizemem))
