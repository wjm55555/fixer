use translate_gci::garbage_collector::*;
...
pub fn create_virtual_machine() -> Box<VIRTUAL_MACHINE> {
    Box::new(VIRTUAL_MACHINE {
        ...
        stack_top: 0,
        stack_cap: 0,
        gc: Box::new(GARBAGE_COLLECTOR::default()),
        trace: 0,
    })
}
